...
AddPackage nodejs            # Evented I/O for V8 javascript ("Current" release) - needed for LazyVim to work
...
AddPackage tree-sitter-cli        # CLI tool for developing, testing, and using Tree-sitter parsers - needed for LazyVim to work
